				...
				<ul class="list">
					...
					<li class="border-top">
						...
						<ul class="nav lt list">
							...
							<li>
								<a data-toggle="tooltip" data-placement='right' title='详单查询' href="${ctx}/console/statistics/specifications/call" class="nav-router" data-router="statistics/statistics"><i class="fa fa-clone icon" aria-hidden="true"> </i> <span>详单查询</span> </a>
							</li>
						</ul>
					</li>
				</ul>
