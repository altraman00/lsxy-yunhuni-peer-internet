...
<header class="bg-green bg header navbar navbar-fixed-top-xs bg-blue">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user nav_b">
        ...
        <li class="hidden-xs"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-bell"></i> <span class="bg-danger <c:if test="${homeVO.messageNum>0}">header-msg</c:if>"  onclick="window.location.href='${ctx}/console/message/account_message/index'"></span> </a>
