...
<header class="bg-green bg header navbar navbar-fixed-top-xs bg-blue">
    ...
    <ul class="nav navbar-nav hidden-xs nav_b">
        <li class="dropdown">
            <a href="${ctx}/console/home" class="dropdown-toggle padding-15" data-toggle="dropdown">
                <span onclick="window.location.href='${ctx}/console/home'" class="" style="letter-spacing: 4px;">管理控制台</span>
            </a>
        </li>
    </ul>
    <ul class="nav navbar-nav navbar-right hidden-xs nav-user nav_b">
        ...
        <li class="hidden-xs a-color"> <a href="#" onclick="window.open('<%=SystemConfig.getProperty("global.official.website.url")%>')" class="dropdown-toggle" data-toggle="dropdown" onclick="window.location.href='news.html' ">
            <img src="${resPrefixUrl }/images/index/index.png" class="header-index-img" alt=""> 首页 </a>
