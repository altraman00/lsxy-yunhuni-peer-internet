                    ...
                    <section class="vbox xbox">
                        ...
                        <section class="scrollable wrapper w-f">
                            ...
                            <section class="panel panel-default pos-rlt clearfix ">
                                ...
                                <form:form action="${ctx}/console/statistics/specifications/code" method="post" id="mainForm">
                                    ...
                                    <c:set var="pageUrl" value="${ctx}/console/statistics/specifications/code"></c:set>
