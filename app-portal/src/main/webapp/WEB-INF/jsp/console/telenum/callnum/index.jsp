                ...
                <aside>
                    <section class="vbox xbox">
                        ...
                        <section class="scrollable wrapper w-f">
                            <section>
                                <p class="number_info">呼入号码作为应用使用IVR功能的拨入号使用，测试阶段可使用统一的测试呼入号码测试IVR功能，应用上线后可租用固定独立的呼入号码实现
                                    交互功能<br>余额不足以支付每月扣除的100元月租费时，相关联的号码将过期，删除应用后关联号码也将自动移除
                                    <br>下线应用后呼入号码自动与应用解除关联
                                    <br>超过有效期7天的号码自动移除</p>
                            </section>
