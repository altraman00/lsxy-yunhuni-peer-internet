                ...
                <form:form role="form" action="${ctx }/reg/register" method="post" class="register-form" id="defaultForm" acceptCharset="utf-8">
                    ...
                    <div class="form-group reader">
                        <div class="col-lg-9 col-lg-offset-3">
                            <input type="checkbox"  id="registerRead"> 点击阅读<a href="${resPrefixUrl}/explain_registe.html">注册协议</a> <span class="tips-error" id="registerReadMsg" hidden>请先阅读注册协议</span>
                        </div>
                    </div>
                    <div class="form-group ">
                        <div class="col-lg-9 col-lg-offset-3">
