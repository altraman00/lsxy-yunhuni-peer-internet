...
public class FileUtil {
	 ...
	 * 
	 * @author jiangxc<br>
	 *         <b>create Date:</b>Jul 13, 2009 2:39:03 PM<br>
	 *         <b>last modify Date:</b>Jul 13, 2009 2:39:03 PM<br>
	 * @param fileContent
	 * @param filePath
	 * @return
	 * @throws IOException
	...
	public static File saveBase64File(String fileContent, String filePath)
		...
		byte[] picBinary = Base64.decodeBase64(fileContent);
	 ...
	 * 
	 * @author jiangxc<br>
	 *         <b>create Date:</b>Jul 13, 2009 2:39:06 PM<br>
	 *         <b>last modify Date:</b>Jul 13, 2009 2:39:06 PM<br>
	 * @param filePath
	 * @return
	 */
...
//			sun.misc.BASE64Encoder encoder = new BASE64Encoder();
			...
			String result = Base64.encodeBase64String(buf.toString().getBytes());
			reader.close();
			return result;
		} catch (Exception e) {
    ...
    public static File getFileFromBytes(byte[] b, String outputFile){
        java.io.BufferedOutputStream stream = null;
        File file = null;
        try{
