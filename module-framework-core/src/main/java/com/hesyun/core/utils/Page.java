 ...
 * @author tantyou
 */
public class Page implements Serializable,JSONUtil2Serialization {
	...
	public String toJson(String[] toJsonProperties) {
		String[] jsonProperties = (String[])ArrayUtils.addAll(toJsonProperties, new String[]{"result",
				"pageSize", "totalCount", "totalPageCount", "startIndex",
				"currentPageNo"});
		return JSONUtil.objectToJson(this, jsonProperties);
	}
