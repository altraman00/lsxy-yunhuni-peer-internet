 ...
 */
@Component
public class Handler_MN_CH_EXT_VERIFY_CALL extends RpcRequestHandler{

    private static final Logger logger = LoggerFactory.getLogger(Handler_MN_CH_EXT_VERIFY_CALL.class);
    ...
    public String getEventName() {
        return ServiceConstants.MN_CH_EXT_VERIFY_CALL;
    }
    ...
    public RPCResponse handle(RPCRequest request, Session session) {
        ...
        try {
            ...
            cticlient.createResource(new BusAddress((byte)0,(byte)0), "ext.notify_call", params, new RpcResultListener(){
                ...
                protected void onResult(Object o) {
                    ...
                    RPCRequest req = RPCRequest.newRequest(ServiceConstants.CH_MN_CTI_EVENT,
                            new MapBuilder<String,Object>()
                                    .put("method", Constants.EVENT_EXT_VERIFY_CALL_SUCCESS)
