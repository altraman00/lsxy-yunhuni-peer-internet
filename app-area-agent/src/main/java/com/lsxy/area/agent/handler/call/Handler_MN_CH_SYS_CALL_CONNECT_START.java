 ...
 */
@Component
public class Handler_MN_CH_SYS_CALL_CONNECT_START extends RpcRequestHandler {
    ...
    public String getEventName() {
        return ServiceConstants.MN_CH_SYS_CALL_CONNECT_START;
    }
    ...
    public RPCResponse handle(RPCRequest request, Session session) {
        ...
        try {
            ...
            cticlient.operateResource( res_id, "sys.call.connect_start", params, new RpcResultListener(){
                @Override
                protected void onResult(Object o) {
                    ...
                    try {
                        ...
                        logger.error("CTI发送事件%s,失败", Constants.EVENT_SYS_CALL_CONNECT_ON_START,e);
                    }
                }

                @Override
                protected void onError(RpcError rpcError) {
                    logger.error("调用sys.call.connect_start失败call_id={},result={}",call_id,rpcError);
                }
