 ...
 */
@Component
public class Handler_MN_CH_SYS_CALL_PLAYLIST_START extends RpcRequestHandler{

    private static final Logger logger = LoggerFactory.getLogger(Handler_MN_CH_SYS_CALL_PLAYLIST_START.class);
    ...
    public String getEventName() {
        return ServiceConstants.MN_CH_SYS_CALL_PLAYLIST_START;
    }
