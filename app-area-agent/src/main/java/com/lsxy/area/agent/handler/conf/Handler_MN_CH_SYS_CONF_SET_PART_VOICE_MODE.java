 ...
 */
@Component
public class Handler_MN_CH_SYS_CONF_SET_PART_VOICE_MODE extends RpcRequestHandler{

    private static final Logger logger = LoggerFactory.getLogger(Handler_MN_CH_SYS_CONF_SET_PART_VOICE_MODE.class);
    ...
    public RPCResponse handle(RPCRequest request, Session session) {
        ...
        try {
            cticlient.operateResource(new BusAddress((byte)0,(byte)0), res_id,"sys.conf.set_part_voice_mode", params, new RpcResultListener(){
