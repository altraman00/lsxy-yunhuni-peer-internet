...
public class ChannelController extends AbstractAPIController {
    ...
    @RequestMapping(value = "/{account_id}/callcenter/channels",method = RequestMethod.POST)
    ...
    @RequestMapping(value = "/{account_id}/callcenter/channels/{id}",method = RequestMethod.DELETE)
    ...
    @RequestMapping(value = "/{account_id}/callcenter/channels",method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/{account_id}/callcenter/channels/{id}",method = RequestMethod.GET)
