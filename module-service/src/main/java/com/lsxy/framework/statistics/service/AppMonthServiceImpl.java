...
public class AppMonthServiceImpl extends AbstractService<AppMonth> implements AppMonthService {
    ...
    public void monthStatistics(Date date, int month,String[] select,String[] all) throws  SQLException{
        ...
        String sql =" insert into db_lsxy_bi_yunhuni.tb_bi_app_month("+selects+" id,dt,month,sum_on_line,sum_line,sum_app_num,create_time,last_time,deleted,sortno,version) ";
        sql +=" select "+selects+"  REPLACE(UUID(), '-', '') as id,? as dt,? as month, ";
