...
public class AppDayServiceImpl extends AbstractService<AppDay> implements AppDayService {
    ...
    public void dayStatistics(Date date, int day,String[] select,String[] all) throws  SQLException{
        ...
        String sql =" insert into db_lsxy_bi_yunhuni.tb_bi_app_day("+selects+" id,dt,day,sum_on_line,sum_line,sum_app_num,create_time,last_time,deleted,sortno,version) ";
        sql +=" SELECT "+selects+"  REPLACE(UUID(), '-', '') as id, ? as dt,? as day, ";
