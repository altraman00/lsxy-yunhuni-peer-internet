 ...
 */
@Component
public class Handler_EVENT_SYS_CALL_SEND_DTMF_ON_FAIL extends EventHandler{

    private static final Logger logger = LoggerFactory.getLogger(Handler_EVENT_SYS_CALL_SEND_DTMF_ON_FAIL.class);
    ...
    public String getEventName() {
        return Constants.EVENT_SYS_CALL_SEND_DTMF_ON_FAIL;
    }
