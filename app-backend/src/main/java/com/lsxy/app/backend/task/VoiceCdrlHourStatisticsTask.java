...
/**
 * 通话记录统计（session统计）定时统计任务-小时统计
 * Created by zhangxb on 2016/7/29.
 */
@Component
public class VoiceCdrlHourStatisticsTask {
    private static final Logger logger = LoggerFactory.getLogger(VoiceCdrlHourStatisticsTask.class);
    @Autowired
    ...
    public void hour(){
        ...
        try{
            ...
            for(int i=0;i<list.size();i++){
                ...
                voiceCdrHourService.hourStatistics(date1,hour1,date2,hour2,list.get(i));
            }
